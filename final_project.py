...
class mainpage(tk.Frame):
  ...
  def thirdpage(self):  #要變第三頁
    ...
    self.btn1 = tk.Label(self, image = self.imageSqrt)
    self.imageSqrt1 = ImageTk.PhotoImage(file = "/Users/xuyuxiang/Desktop/image/螢幕快照 2019-01-13 下午5.17.45.png")
    self.check1 = tk.Button(self, image = self.imageSqrt1, width = 340, command = lambda:[self.fourpage(), portfolio.solve(method = 'I', shortsale = True)])
    self.explain1 = tk.Label(self, text = "用自己的歷史作預測，可持有負的權重", height = 1, width = 30, font = f2)
    self.imageSqrt2= ImageTk.PhotoImage(file = "/Users/xuyuxiang/Desktop/image/螢幕快照 2019-01-13 下午5.17.54.png")
    self.check2 = tk.Button(self, image = self.imageSqrt2, width = 340, command = lambda:[self.fourpage(), portfolio.solve(method = 'I', shortsale = False)])
    self.explain2 = tk.Label(self, text = "用自己的歷史作預測，不可持有負的權重", height = 1, width = 30, font = f2)
    self.imageSqrt3 = ImageTk.PhotoImage(file = "/Users/xuyuxiang/Desktop/image/螢幕快照 2019-01-13 下午5.29.48.png")
    self.check3 = tk.Button(self, image = self.imageSqrt3, width = 340, command = lambda:[self.fourpage(), portfolio.solve(method = 'M', shortsale = True)])
    self.explain3 = tk.Label(self, text = "用大盤的歷史作預測，可持有負的權重", height = 1, width = 30, font = f2)
    self.imageSqrt4 = ImageTk.PhotoImage(file = "/Users/xuyuxiang/Desktop/image/螢幕快照 2019-01-13 下午5.30.14.png")
    self.check4 = tk.Button(self, image = self.imageSqrt4, width = 340, command = lambda:[self.fourpage(), portfolio.solve(method = 'M', shortsale = False)])
    self.explain4 = tk.Label(self, text = "用大盤的歷史作預測，不可持有負的權重", height = 1, width = 30, font = f2)

    self.btn1.grid(row = 0, column = 0, columnspan = 3, pady = 50)
    self.check1.grid(row = 1, column = 0, pady = 10)
    self.explain1.grid(row = 1, column = 1, columnspan = 2, pady = 10)
    self.check2.grid(row = 2, column = 0, pady = 10)
    self.explain2.grid(row = 2, column = 1, columnspan = 2, pady = 10)
    self.check3.grid(row = 3, column = 0, pady = 10)
    self.explain3.grid(row = 3, column = 1, pady = 10)
    self.check4.grid(row = 4, column = 0, pady = 10)
    self.explain4.grid(row = 4, column = 1, columnspan = 2, pady = 10)
  ...
  def fivepage(self) :
    ...
    self.btn6 = tk.Label(self, text = str(round(weight[0]*100,2))+"%", height = 1, width = 8, font = f2)
    self.blank2 = tk.Label(self, height = 1, width = 2)
    self.btn7 = tk.Label(self, text = name2[2], height = 1, width = 8, font = f2)
    self.btn8 = tk.Label(self, text = str(round(weight[1]*100,2))+"%", height = 1, width = 8, font = f2)
    self.btn9 = tk.Label(self, text = name2[3], height = 1, width = 8, font = f2)
    self.btn10 = tk.Label(self, text = str(round(weight[2]*100,2))+"%", height = 1, width = 8, font = f2)
    self.blank3 = tk.Label(self, height = 1, width = 2)
    self.btn11 = tk.Label(self, text = name2[4], height = 1, width = 8, font = f2)
    self.btn12 = tk.Label(self, text = str(round(weight[3]*100,2))+"%", height = 1, width = 8, font = f2)
    self.btn13 = tk.Label(self, text = name2[5], height = 1, width = 8, font = f2)
    self.btn14 = tk.Label(self, text = str(round(weight[4]*100,2))+"%", height = 1, width = 8, font = f2)
    self.blank4 = tk.Label(self, height = 1, width = 2)
    self.btn15 = tk.Label(self, text = name2[6], height = 1, width = 8, font = f2)
    self.btn16 = tk.Label(self, text = str(round(weight[5]*100,2))+"%", height = 1, width = 8, font = f2)
    self.btn17 = tk.Label(self, text = name2[7], height = 1, width = 8, font = f2)
    self.btn18 = tk.Label(self, text = str(round(weight[6]*100,2))+"%", height = 1, width = 8, font = f2)
    self.blank5 = tk.Label(self, height = 1, width = 2)
    self.btn19 = tk.Label(self, text = name2[8], height = 1, width = 8, font = f2)
    self.btn20 = tk.Label(self, text = str(round(weight[7]*100,2))+"%", height = 1, width = 8, font = f2)
    self.btn21 = tk.Label(self, text = name2[9], height = 1, width = 8, font = f2)
    self.btn22 = tk.Label(self, text = str(round(weight[8]*100,2))+"%", height = 1, width = 8, font = f2)
    self.blank6 = tk.Label(self, height = 1, width = 2)
    self.btn23 = tk.Label(self, text = name2[10], height = 1, width = 8, font = f2)
    self.btn24 = tk.Label(self, text = str(round(weight[9]*100,2))+"%", height = 1, width = 8, font = f2)
